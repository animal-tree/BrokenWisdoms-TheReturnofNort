...
At the very least, Right To Talk About Suicide Without Hospitalization, Drugging, Or Police Action should be legalized (or rather, standardized, if the serious suicide plans that are still planned and intended are to be actually prevented).
