...
> [!NOTE]
> ### Transcending repressions, constrictions, & Hell
> 
...
> - Navigating emotional realms where you might get perceived as a predator — as traditionally was and perhaps still is one of the main struggles of transitioning — is hard. At the same time, the more emotional realms exist for you, and whatever their means of expression (e.g., dress), where you might be bullied, laughed at ("Lol alright"), or blocked for having or showing those emotions, the harder, as well. Those external pressures can act like invisible Hells, that the process of transcending, into finding your own identity and sincere expression, is hard, and can result in counterintuitive statistics.
> - Controversial claim: there are more than just two spectrum categories! Of transcend-able identity, that is. Transcend-able identity is a spectrum. “Woke” is transcending (1) gender, and (2) sexuality. “Enlightenment” is transcending all permanent negative judgement of others. If an Age of Enlightenment is ever to come (another “Renaissance”), such a time will be marked by when all people are given their identity, gender, and sexual satisfaction, from the very most promiscuous to the utmost jealous to the horniest beyond reproach, with limits that come from intelligence and a society that is so innocent and loving that Adam and Eve (and Steve) will know how to approach each other’s hearts, by their human nature, uncorrupted by stress and systems of oppression, and when not to. 
>
