...
> - Navigating emotional realms where you might get perceived as a predator — as traditionally was and perhaps still is one of the main struggles of transitioning — is hard. At the same time, the more emotional realms exist for you where you might be bullied for having or showing those emotions, the harder, as well. Those external pressures can act like invisible Hells, that the process of transcending, into finding your own identity and sincere expression, is often filled with persecution, trauma, and pain.
>
