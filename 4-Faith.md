...
The social mobility to transcend those societal Hells, is a problem that [men](https://afsp.org/suicide-statistics/) and [trans people](https://www.statista.com/statistics/1388565/us-trans-suicide-rate/) disproportionately face, apparently, which may come as a surprise since "social mobility" is usually thought of as economic or material, rather than emotional or the spectrums of psychology and memory that one struggles to navigate, in themselves and in their outer actions.
