...
Here is an excerpt from my own suicide note that I'd written and was going to use, trying to describe what my last moments hypothetically would've been, that also addresses the question of whether it's amoral for somebody "to do that to someone," as in, the question of whether a suicide victim is selfish for "choosing" that path:
