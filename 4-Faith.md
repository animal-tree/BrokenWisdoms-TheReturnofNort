...
>   - I don't mean nullifying. If a person has to nullify their emotions, experiences, and impetuses, the only way to do that, besides drugging oneself into an omelet, is to die.
