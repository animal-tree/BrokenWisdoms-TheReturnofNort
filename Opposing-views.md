...
In Chenliang's group, I was still trying to do my own research, which was pretty heavily bottlenecked. That's part of why I stayed up days and nights then, too, practicing every discipline imaginable — from freezing cold ice baths to Transcendental Meditation to yoga to strict steak-only diet to every ascetecism I could not-hope for — to achieve the [full scope](https://github.com/AGI-init/UnifiedML-legacy) of what I wanted to do for [both](https://github.com/AGI-init/XRDs).
